...
import ruoyuli.cs301.cs.wm.edu.amazebyruoyu.gui.*;
//import ruoyuli.cs301.cs.wm.edu.amazebyruoyu.generation.Controller.Robots;
...
public class StatePlaying extends DefaultState {
    ...
    private boolean mapMode = false; // true: display map of maze, false: do not display map of maze
    ...
    public void toEnd(boolean win, boolean manual) {
        if (manual) {
    ...
    public void setActivity(PlayManuallyActivity manuallyActivity) {
        this.playManuallyActivity = manuallyActivity;
    }

    public void setActivity(PlayAnimationActivity animationActivity) {
        this.playAnimationActivity = animationActivity;
    }
